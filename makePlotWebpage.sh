...
cd ${destination}
  ...
  echo "<a href=\"pars.txt\"><H3><font color=\"${blue}\"> Fit parameters human readable </font></H3></a>" >> ${file}
  echo "<a href=\"pars.tex\"><H3><font color=\"${blue}\"> Fit parameters LaTeX </font></H3></a>" >> ${file}
